...
computer_brand = "Dell"  # Replace with your actual computer brand
print(f"I have a {computer_brand} computer.")
print()

# Exercise 5: Your information
print("=== Exercise 5: Your information ===")
name = "mebratu"  # Replace with your name
...
my_name = "mebratu"  # Replace with your actual name
user_name = input("What's your name? ")

if user_name.lower() == my_name.lower():
    print("Wow! We have the same name! What are the odds? ")
else:
    print(f"Nice to meet you, {user_name}! {my_name} is clearly the better name though!")
print()
